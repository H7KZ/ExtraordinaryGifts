...
public class PlayerMessage {
    public static final String eGiftsCommandNoPermission = "§ceGifts: You don't have permission to use this command!";
    public static final String createCommandNotEnoughBalance = "§ceGifts: You don't have enough balance to create a gift or you aren't holding it in the main hand! To see all possible ways of paying, type /gift economy.";
